...
$(document).ready(function(){
    ...
    if (slider !== undefined && slider !== null) {
        slider.slick({
            ...
            speed: 1000,
            fade: true,
            nextArrow: '<img class="next" src="img/right-arr.svg" alt="" width="48" height="48">',
            prevArrow: '<img class="prev" src="img/left-arr.svg" alt="" width="48" height="48">'
        });
    }
    ...
    if (SliderVariableWidth !== undefined && SliderVariableWidth !== null) {
        SliderVariableWidth.slick({
            ...
            centerMode: true,
            variableWidth: true,
            nextArrow: '<img class="next" src="img/right.svg" alt="" width="48" height="48">',
            prevArrow: '<img class="prev" src="img/left.svg" alt="" width="48" height="48">'
